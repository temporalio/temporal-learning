...
title: Background Check Application in Java
...
- [How to develop a Workflow Definition in Java](https://docs.temporal.io/dev-guide/java/foundations/#develop-workflows)
- [How to spawn a Workflow Execution in Java](https://docs.temporal.io/dev-guide/java/foundations/#start-workflow-execution)
- [How to set StartWorkflowOptions in Java](https://docs.temporal.io/dev-guide/java/foundations/#set-task-queue)
- [How to get the result of a Workflow Execution in Java](https://docs.temporal.io/dev-guide/java/foundations/#get-workflow-results)
- [How to send a Cancellation Request to a Workflow Execution in Java](https://docs.temporal.io/dev-guide/java/testing/#cancel-an-activity)
- [How to use Signals in Java](https://docs.temporal.io/dev-guide/java/features/#signals)
- [How to send a Query to a Workflow Execution in Java](https://docs.temporal.io/dev-guide/java/features/#send-query)
- [How to handle a Query in a Workflow in Java](https://docs.temporal.io/dev-guide/java/features/#handle-query)
- [How to spawn a Child Workflow Execution in Java](https://docs.temporal.io/dev-guide/java/features/#child-workflows)
- [How to spawn an Activity Execution in Java](https://docs.temporal.io/dev-guide/java/foundations/#activity-execution)
- [How to develop an Activity Definition in Java](https://docs.temporal.io/dev-guide/java/foundations/#activity-definition)
- [How to set ActivityOptions in Java](https://docs.temporal.io/dev-guide/java/foundations/#activity-parameters)
- [How to develop a Worker Program in Java](https://docs.temporal.io/dev-guide/java/foundations/#run-worker-processes)
- [How to provide a custom Data Converter in Java](#)
- [How to execute a Side Effect in Java](https://docs.temporal.io/dev-guide/java/features/#side-effects)
