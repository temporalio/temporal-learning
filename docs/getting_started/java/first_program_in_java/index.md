...
## ![](/img/icons/repair-tools.png) Project setup
...
<img alt="Celebratory confetti" class="docs-image-centered docs-image-max-width-20" src="/img/icons/confetti.png" />

**Congratulations**, you just ran a Temporal Workflow application!

## ![](/img/icons/warning.png) Failure simulation
...
<img alt="Business person blasting off with a backpack rocket" class="docs-image-centered docs-image-max-width-20" src="/img/icons/boost.png" />
