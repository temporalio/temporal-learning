...
[shared.go](https://github.com/temporalio/money-transfer-project-template-go/blob/cloud/shared.go)
```go
...
[start/main.go](https://github.com/temporalio/money-transfer-project-template-go/blob/cloud/start/main.go)
```go
func main() {
