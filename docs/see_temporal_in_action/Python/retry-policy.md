...
<div className="temporal-tour-container">
  ...
  <div className="content-area">
    ...
    <div className="tour-navigation">
        <Link className="button button--primary next-step" to="/see_temporal_in_action/python/adding-an-error">
          Next Step
        </Link>
      </div>
    </div>
    ...
    <div className="right-panel">
      <div className="demo-area">
        <div className="demo-header">
          <a href="https://github.com/temporalio/edu-get-started-flow/blob/main/python/workflows.py" 
