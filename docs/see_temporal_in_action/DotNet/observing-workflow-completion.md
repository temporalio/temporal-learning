  ...
  <div className="content-area">
    <div className="left-panel">
      ...
      <div className="tour-navigation">
        <Link className="button button--primary next-step" to="/getting_started/dotnet">
    ...
    <div className="right-panel">
      <div className="demo-area">
        ...
        <div className="image-preview">
          <img src="/see_temporal_in_action/dotnet/images/workflow-execution-complete-ts.png" alt="Workflow Execution Completion in Temporal Web UI" />
        </div>
      </div>
    </div>
  </div>
