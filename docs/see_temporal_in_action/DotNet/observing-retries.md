    ...
    <div className="right-panel">
      <div className="demo-area">
        ...
        <div className="image-preview">
          <img src="/see_temporal_in_action/dotnet/images/error-workflow-ts.png" alt="Activity Retries in Temporal Web UI" />
        </div>
      </div>
    </div>
  </div>
