...
<div className="temporal-tour-container">
    ...
    <div className="left-panel">
      <div className="tour-header">
        ...
        <div className="content-text">
          <p>Let's start out with a basic reimbursement function that:</p>
          <ul>
    ...
    <div className="right-panel">
      <div className="demo-area">
        ...
        <div className="code-preview">
          <pre className="codeblock"><code className="language-dotnet">{`export async function reimbursementWorkflow(userId: string, amount: number): Promise<string> {
  ...
  <div className="step-navigation">
    <div className="step-indicator">1 / 10</div>
  </div>
</div>
