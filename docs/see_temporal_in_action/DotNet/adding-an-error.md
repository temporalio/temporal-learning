    ...
    <div className="right-panel">
      <div className="demo-area">
        ...
        <div className="code-preview">
          <pre className="codeblock"><code className="language-dotnet">{`export async function withdrawMoney(amount: number): Promise<void> {
...
export async function depositMoney(amount: number): Promise<void> {
  ...
  <div className="step-navigation">
    <div className="step-indicator">7 / 10</div>
  </div>
</div>
