...
<div className="temporal-tour-container">
  ...
  <div className="content-area">
    <div className="left-panel">
      <div className="tour-header">
        ...
        <div className="content-text">
          ...
          <p>A Worker polls a queue that you configure it to poll, looking for work to do. This queue is known as a Task Queue. Once the Worker dequeues a Workflow or Activity task from the Task Queue, it then executes that task.</p>
          <p>The Worker itself is provided by the Temporal SDK, and your application configures and runs it. Workers communicate with Temporal to coordinate work, while your code continues to be executed by Workers that you own.</p> 
    ...
    <div className="tour-navigation">
        <Link className="button button--primary next-step" to="/see_temporal_in_action/dotnet/client">
          Next Step
        </Link>
      </div>
    </div>
    ...
    <div className="right-panel">
      <div className="demo-area">
        ...
        <div className="code-preview">
          <pre><code className="language-dotnet">{`import {Worker} from '@temporalio/worker';
...
`}</code></pre>
  ...
  <div className="step-navigation">
    <div className="step-indicator">4 / 10</div>
  </div>
</div>
