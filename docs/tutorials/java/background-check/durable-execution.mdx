...
This chapter builds on the [Construct a new Temporal Application project](https://docs.temporal.io/develop/java/set-up-your-local-java#create-a-project) chapter and relies on the Background Check use case and sample applications as a means to contextualize the information.
...
[Start a new Workflow](https://docs.temporal.io/develop/java/set-up-your-local-java#6-execute-the-workflow) and after it is complete [download the Event History as a JSON object](#retrieve-event-history).
