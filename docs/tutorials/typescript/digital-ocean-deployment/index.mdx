...
Digital Ocean is provides flexible Cloud servers called Droplets that can be used to host your application.
...
## Set up Nginx as a reverse proxy {#set-up-nginx}
