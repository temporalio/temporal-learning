---
id: index
title: Part 1 -- Build a Work Queue Slack App with Temporal in Typescript
...
sidebar_label: Part 1 -- Build a Work Queue Slack App with Temporal in Typescript
tags:
  - typescript
  - slack-app
keywords:
...
To use Temporal Cloud in production, see the [Deploy your application to Digital Ocean](/tutorials/typescript/work-queue-slack-app/deploy) part of the tutorial for more information.
...
Per the [12 Factor App methodology](https://12factor.net/config), you should not commit these to your project repository, hard code them in your application in any way, or store them in configuration files.
...
**Next, [Deploy your TypeScript Slack App to production on a Digital Ocean Droplet using Temporal Cloud](/tutorials/typescript/work-queue-slack-app/deploy)**.
