---
id: index
title: Part 2 -- Deploy a TypeScript Slack App to production on a Digital Ocean Droplet using Temporal Cloud
...
sidebar_label: Part 2 -- Deploy a TypeScript Slack App to production on a Digital Ocean Droplet using Temporal Cloud
tags:
  - typescript
  - deployment
  - digital-ocean
...
In this tutorial we will walk through the steps to deploy your Temporal backed Slack App to a Digital Ocean Droplet while using Temporal Cloud as your Temporal Application's orchestrator.
...
However, you will need to ensure that these same environment variables are set when you deploy your code to your Digital Ocean Droplet.
