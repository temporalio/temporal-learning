...
In the following steps you will add your PEM (certificate) and Private Key to your `.env` file as environment variables.

You also need to save the PEM (certificate) to your Temporal Cloud Namespace.
In your Temporal Cloud Account, navigate to Namespaces, and select the Namespace you want to use.
Then, scroll down to the "CA Certificates" section, and copy in the PEM (certificate) you generated.

![Temporal Cloud Namespace CA Certificates](./images/save-cert-to-namespace.png)
