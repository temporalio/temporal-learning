...
DigitalOcean provides flexible Cloud servers called Droplets that you can use to host your Slack application.
...
First, you'll update your Temporal Client.
...
To use Temporal Cloud, change the Temporal Client code so it includes the namespace and certificate information:
...
Now update each of your `.env` files with your Temporal Cloud credentials so you can test your application locally to ensure it works with Temporal Cloud.

You should have the following Temporal Cloud credentials to add to your `.env` files:
