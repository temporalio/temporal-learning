...
If you want to deploy your TypeScript application to Digital Ocean, see the [Deploy your TypeScript application to Digital Ocean](/tutorials/typescript/digital-ocean-deployment) tutorial for more information.
