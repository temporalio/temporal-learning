...
- `--type`: This is the Workflow Type name.
  ...
  In the Go SDK, this name can be customized when [registering the Worklow with the Workflow](https://docs.temporal.io/develop/go/workflows/basics#customize-workflow-type).
