---
title: "Crafting an Error Handling Strategy with TypeScript"
sidebar_position: 4
sidebar_label: "Crafting an Error Handling Strategy with TypeScript"
draft: false
...
Since code used in examples and exercises are written in TypeScript, you must also have at least basic proficiency with the TypeScript programming language.
 ...
 <a className="button button--primary" href="https://temporal.talentlms.com/catalog/info/id:244">Go to Course</a> 