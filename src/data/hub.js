...
export const FIRST_STEPS = [
  {
    ...
    shortLabel: "See it run",
    description: "See the power of Temporal in a live lab - no install required.",
    href: "/start/run-a-transfer",
  },
  {
    n: 2,
    duration: "~15 min",
    ...
    description: "Install the SDK and CLI and get a local Temporal Service running.",
  ...
  },
  {
    ...
    description: "Write and run your first Temporal application from scratch, step by step in your language.",
