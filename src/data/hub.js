...
export const PATHS = [
  ...
  },
  {
    ...
    tier: "advanced",
    persona: "ai",
    title: "Build Durable AI Agents",
    description:
      "Patterns for durable LLM workflows, MCP tools, and long-running agentic systems.",
    level: "production",
    lessonCount: 4,
    courses: [
...
export const COURSES = [
  ...
  },
  {
    ...
    topics: ["event-history", "search-attributes", "testing", "versioning"],
    level: "production",
    durationMinutes: 90,
    sdkLanguages: ["go", "java", "python", "typescript"],
    lessonCount: 5,
