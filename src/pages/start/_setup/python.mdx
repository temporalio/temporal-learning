...
<SetupStep code={
<>
<CodeSnippet language="bash">{`python3 -V`}</CodeSnippet>
<CodeSnippet language="bash">{`python 3.13.3`}</CodeSnippet>
</>
}>
...
<SetupStep code={
<>
<CodeSnippet language="bash">{`mkdir temporal-project`}</CodeSnippet>
<CodeSnippet language="bash">{`cd temporal-project`}</CodeSnippet>
<CodeSnippet language="bash">{`python3 -m venv env`}</CodeSnippet>
<CodeSnippet language="bash">{`source env/bin/activate`}</CodeSnippet>
<CodeSnippet language="bash">{`pip install temporalio`}</CodeSnippet>
</>
}>
