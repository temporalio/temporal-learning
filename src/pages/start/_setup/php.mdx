import { SetupSteps, SetupStep, CodeSnippet } from '@site/src/components/hub/setup/SetupSteps';
...
<SetupStep code={
<>
<CodeSnippet language="bash">{`php -v`}</CodeSnippet>
</>
}>
...
<CodeSnippet language="bash">{`composer init --name="myproject/quickstart" -n`}</CodeSnippet>
</>
}>
...
<SetupStep code={
<>
<CodeSnippet language="bash">{`composer require temporal/sdk`}</CodeSnippet>
<CodeSnippet language="json">{`{\n    "name": "myproject/quickstart",\n    "require": {\n        "temporal/sdk": "^2.16"\n    },\n    "autoload": {\n        "psr-4": {\n            "App\\\\": "src/"\n        }\n    }\n}`}</CodeSnippet>
<CodeSnippet language="bash">{`composer dump-autoload`}</CodeSnippet>
</>
}>
...
<CodeSnippet language="bash">{`./vendor/bin/rr get`}</CodeSnippet>
...
<CodeSnippet language="xml">{`<download software="temporal" version="^1.5"/>`}</CodeSnippet>
