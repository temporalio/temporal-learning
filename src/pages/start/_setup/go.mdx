...
<SetupStep code={
<>
<CodeSnippet language="bash">{`go version`}</CodeSnippet>
<CodeSnippet language="bash">{`go version go1.18.1 darwin/amd64`}</CodeSnippet>
</>
}>
...
<SetupStep code={
<>
<CodeSnippet language="bash">{`mkdir goproject`}</CodeSnippet>
<CodeSnippet language="bash">{`cd goproject`}</CodeSnippet>
<CodeSnippet language="bash">{`go mod init my-org/greeting`}</CodeSnippet>
<CodeSnippet language="bash">{`go get go.temporal.io/sdk`}</CodeSnippet>
<CodeSnippet language="bash">{`go get go.temporal.io/sdk/client`}</CodeSnippet>
<CodeSnippet language="bash">{`go mod tidy`}</CodeSnippet>
</>
}>
