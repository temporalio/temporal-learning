...
const TITLE = "Versioning Workflows with TypeScript";
const DESCRIPTION =
...
const COURSE_URL = "https://temporal.talentlms.com/catalog/info/id:171";
...
export default function VersioningTypeScriptPage() {
  return (
      ...
      <div className="nd-hub-page">
        ...
        <div className={styles.pageLayout}>
          ...
          >
            ...
            <MetaChips items={["~1.5 hours, self-paced", "Free", "TypeScript"]} />
