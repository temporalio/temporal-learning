...
const TITLE = "Versioning Workflows with Go";
const DESCRIPTION =
...
const COURSE_URL = "https://temporal.talentlms.com/catalog/info/id:167";
...
export default function VersioningGoPage() {
  return (
      ...
      <div className="nd-hub-page">
        ...
        <div className={styles.pageLayout}>
          ...
          >
            ...
            <MetaChips items={["~1.5 hours, self-paced", "Free", "Go"]} />
