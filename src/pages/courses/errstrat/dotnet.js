...
const TITLE = "Crafting an Error Handling Strategy with .NET";
const DESCRIPTION =
...
const COURSE_URL = "https://temporal.talentlms.com/catalog/info/id:258";
...
export default function ErrstratDotnetPage() {
  return (
      ...
      <div className="nd-hub-page">
        ...
        <div className={styles.pageLayout}>
          ...
          >
            ...
            <MetaChips items={["~2.5 hours, self-paced", "Free", ".NET"]} />
