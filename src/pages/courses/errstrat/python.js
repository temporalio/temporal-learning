...
const TITLE = "Crafting an Error Handling Strategy with Python";
const DESCRIPTION =
...
const COURSE_URL = "https://temporal.talentlms.com/catalog/info/id:245";
...
export default function ErrstratPythonPage() {
  return (
