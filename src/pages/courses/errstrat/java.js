...
const TITLE = "Crafting an Error Handling Strategy with Java";
const DESCRIPTION =
  "In this course, you will design and implement effective error handling strategies that map your business logic to the Temporal platform. You will explore the nature of different types of failures and investigate the support that Temporal provides for addressing them. Along the way, you will encounter essential concepts and techniques, such as idempotence, Heartbeating, and the Saga Pattern, which will help you to ensure the correctness and responsiveness of your application.";
const COURSE_URL = "https://temporal.talentlms.com/catalog/info/id:243";
...
export default function ErrstratJavaPage() {
  return (
      ...
      <div className="nd-hub-page">
        ...
        <div className={styles.pageLayout}>
          ...
          >
            ...
            <MetaChips items={["~2.5 hours, self-paced", "Free", "Java"]} />
