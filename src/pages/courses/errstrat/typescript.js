...
const TITLE = "Crafting an Error Handling Strategy with TypeScript";
const DESCRIPTION =
...
const COURSE_URL = "https://temporal.talentlms.com/catalog/info/id:244";
...
export default function ErrstratTypeScriptPage() {
  return (
