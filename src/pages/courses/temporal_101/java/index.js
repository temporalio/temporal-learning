...
const TITLE = "Temporal 101 with Java";
const DESCRIPTION =
...
const COURSE_URL = "https://temporal.talentlms.com/catalog/info/id:140";
...
export default function Temporal101JavaPage() {
  return (
      ...
      <div className="nd-hub-page">
        ...
        <div className={styles.pageLayout}>
          ...
          >
            ...
            <MetaChips items={["~2 hours, self-paced", "Free", "Java"]} />
            ...
            <section className={styles.section}>
              ...
              <p>
                ...
                blocks along with Temporal's Java SDK to develop a small
            ...
            <section className={styles.section}>
              ...
              <p>
                This course uses the Java programming language. Although the
                code examples and hands-on exercises are written in Java, they
                include explanations and avoid advanced language features, so
                a developer with minimal Java experience should be able to
                successfully complete this course.
              </p>
            </section>

            <div style={{ display: "flex", justifyContent: "center", gap: "12px", flexWrap: "wrap", padding: "32px 24px 64px" }}>
              <MagentaCta to="/courses/temporal_101/java/understanding-workflow-execution/about-this-example/">
