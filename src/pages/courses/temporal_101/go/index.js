...
const TITLE = "Temporal 101 with Go";
const DESCRIPTION =
...
const COURSE_URL = "https://temporal.talentlms.com/catalog/info/id:126";
...
export default function Temporal101GoPage() {
  return (
      ...
      <div className="nd-hub-page">
        ...
        <div className={styles.pageLayout}>
          ...
          >
            ...
            <MetaChips items={["~2 hours, self-paced", "Free", "Go"]} />
            ...
            <section className={styles.section}>
              ...
              <p>
                ...
                blocks along with Temporal's Go SDK to develop a small
            ...
            <section className={styles.section}>
              ...
              <p>
                This course uses the Go programming language. Previous Go
                experience is helpful, but not required.
              </p>
            </section>

            <div style={{ display: "flex", justifyContent: "center", gap: "12px", flexWrap: "wrap", padding: "32px 24px 64px" }}>
              <MagentaCta to="/courses/temporal_101/go/understanding-workflow-execution/about-this-example/">
