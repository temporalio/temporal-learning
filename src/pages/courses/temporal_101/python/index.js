...
const TITLE = "Temporal 101 with Python";
const DESCRIPTION =
  "Discover the essentials of Temporal application development in this course, focusing on Workflows, Activities, and the Temporal Python SDK. Start the course today.";
...
export default function Temporal101PythonPage() {
  return (
      ...
      <div className="nd-hub-page">
        ...
        <div className={styles.pageLayout}>
          ...
          >
            ...
            <MetaChips items={["~2 hours, self-paced", "Free", "Python"]} />
            ...
            <section className={styles.section}>
              ...
              <p>
                ...
                blocks along with Temporal's Python SDK to develop a small
            ...
            <section className={styles.section}>
              ...
              <p>
                This course uses the Python programming language. Although
                the code examples and hands-on exercises are written in
                Python, they include explanations and avoid advanced language
                features, so a developer with minimal Python experience
                should be able to successfully complete this course.
              </p>
            </section>

            <div style={{ display: "flex", justifyContent: "center", gap: "12px", flexWrap: "wrap", padding: "32px 24px 64px" }}>
              <MagentaCta to="/courses/temporal_101/python/understanding-workflow-execution/about-this-example/">
