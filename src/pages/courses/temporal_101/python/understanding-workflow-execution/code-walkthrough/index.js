// Free preview lesson 2 of 2 for Temporal 101 (Python).
// Source: https://github.com/temporalio/edu-101-python-content/blob/main/understanding-workflow-execution/code-walkthrough.md
...
export default function CodeWalkthroughPage() {
  return (
    <Layout
      title="Code walkthrough - Understanding Workflow Execution (Python)"
      description="Watch a guided walkthrough of how the Python Temporal application executes step by step, including failure and retry scenarios."
    >
        ...
        <div className={styles.pageLayout}>
          ...
          <main className={styles.pageMain}>
            ...
            <p className={styles.intro}>
              Watch this walkthrough to see how all of the parts of a Temporal
              Application work together as the Workflow executes - including
              what happens when the Worker crashes or a microservice goes
              offline.
            </p>
            ...
            <section className={styles.section} id="video">
              ...
              >
                <iframe
                  width="1040"
                  height="585"
                  src="https://www.youtube.com/embed/nH9dHLY6sV0?rel=0&iv_load_policy=3&modestbranding=1&showsearch=0&showinfo=0"
            ...
            <section className={styles.section} id="transcript">
              ...
              <details>
                ...
                <p>
                  ...
                  unless at least one Worker is running. Launching the Worker
                  creates a new process. Since this example is written in
                  Python, you can define a main function and use it to start
                  execution.
                </p>
                ...
                <p>
                  ...
                  <code>start_workflow</code> method with your input.
                </p>
                <p>
                ...
                <p>
                  ...
                  method from the Workflow Definition. It continues by running
                  code within this method. In the Python SDK, Activity options
                  such as <code>start_to_close_timeout</code> are passed in
                  via key word arguments when executing the Activity.
                </p>
                <p>
                  ...
                  <code>greet_in_spanish</code>. Since{" "}
                  <code>execute_activity_method</code> waits for the Activity
                  to complete before proceeding, the result of the activity
                  will be stored in <code>greeting</code> and is immediately
                  ready for our use.
                </p>
                <p>
                  A few important things happen as a result of the{" "}
                  <code>execute_activity_method</code> call. The Worker can't
                  make further progress on the Workflow until the Activity
                  ...
                  command to the cluster requesting it to schedule an Activity
                  Task.
                </p>
                <p>
                ...
                <p>
                  ...
                  the Activity Definition for the <code>greet_in_spanish</code>{" "}
                  Activity.
                </p>
                <p>
                ...
                <p>
                  When the Worker accepts this new Task, the Temporal Cluster
                  adds a <code>WorkflowTaskStarted</code> Event to the
                  history. The Worker continues where it left off, executing
                  the remaining statements in the Workflow Definition.
                </p>
                <p>Once this method returns, the Workflow Task is complete.</p>
                <p>
                  Since the Workflow method returned, Workflow Execution is
            ...
            <div className={styles.nextSection}>
              ...
              <div style={{ display: "flex", justifyContent: "center" }}>
                <MagentaCta href="https://temporal.talentlms.com/catalog/info/id:143">
            ...
            <div className={styles.chapterNav}>
              <Link
                to="/courses/temporal_101/python/understanding-workflow-execution/about-this-example/"
