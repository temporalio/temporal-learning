        ...
        <div className={styles.pageLayout}>
          ...
          <main className={styles.pageMain}>
            ...
            <p className={styles.intro}>
              During the <a href="https://github.com/temporalio/edu-101-dotnet-code/blob/main/exercises/farewell-workflow/README.md" target="_blank" rel="noopener noreferrer" style={{ color: "inherit" }}>previous exercise</a>, you executed a Workflow that
