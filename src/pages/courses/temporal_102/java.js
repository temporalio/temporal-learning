...
const TITLE = "Temporal 102: Exploring Durable Execution with Java";
const DESCRIPTION =
...
const COURSE_URL = "https://temporal.talentlms.com/catalog/info/id:164";
...
export default function Temporal102JavaPage() {
  return (
      ...
      <div className="nd-hub-page">
        ...
        <div className={styles.pageLayout}>
          ...
          >
            ...
            <MetaChips items={["~4 hours, self-paced", "Free", "Java"]} />
