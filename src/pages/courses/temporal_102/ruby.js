...
const TITLE = "Temporal 102: Exploring Durable Execution with Ruby";
const DESCRIPTION =
...
const COURSE_URL = "https://temporal.talentlms.com/catalog/info/id:303";
...
export default function Temporal102RubyPage() {
  return (
      ...
      <div className="nd-hub-page">
        ...
        <div className={styles.pageLayout}>
          ...
          >
            ...
            <MetaChips items={["~4 hours, self-paced", "Free", "Ruby"]} />
            ...
            <section className={styles.section}>
              ...
              <p>
                ...
                applications with the Ruby SDK. This includes the ability to
              ...
              <p>
                ...
                Ruby, you must also have at least basic proficiency with the
