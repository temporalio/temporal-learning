...
const TITLE = "Interacting with Workflows with TypeScript";
const DESCRIPTION =
...
const COURSE_URL = "https://temporal.talentlms.com/catalog/info/id:207";
...
export default function InteractingTypeScriptPage() {
  return (
      ...
      <div className="nd-hub-page">
        ...
        <div className={styles.pageLayout}>
          ...
          >
            ...
            <MetaChips items={["~3 hours, self-paced", "Free", "TypeScript"]} />
            ...
            <section className={styles.section}>
              ...
              <p>
                ...
                Temporal 101 and 102, which cover these topics, before
