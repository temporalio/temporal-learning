...
const TITLE = "Interacting with Workflows with Go";
const DESCRIPTION =
...
const COURSE_URL = "https://temporal.talentlms.com/catalog/info/id:213";
...
export default function InteractingGoPage() {
  return (
      ...
      <div className="nd-hub-page">
        ...
        <div className={styles.pageLayout}>
          ...
          >
            ...
            <MetaChips items={["~3 hours, self-paced", "Free", "Go"]} />
