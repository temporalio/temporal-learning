...
const TITLE = "Securing Application Data with Java";
const DESCRIPTION =
...
const COURSE_URL = "https://temporal.talentlms.com/catalog/info/id:212";
...
export default function AppdatasecJavaPage() {
  return (
