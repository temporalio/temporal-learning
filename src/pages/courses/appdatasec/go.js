...
const TITLE = "Securing Application Data with Go";
const DESCRIPTION =
...
const COURSE_URL = "https://temporal.talentlms.com/catalog/info/id:209";
...
export default function AppdatasecGoPage() {
  return (
