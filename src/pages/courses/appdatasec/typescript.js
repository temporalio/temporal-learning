...
const TITLE = "Securing Application Data with TypeScript";
const DESCRIPTION =
...
const COURSE_URL = "https://temporal.talentlms.com/catalog/info/id:211";
...
export default function AppdatasecTypeScriptPage() {
  return (
      ...
      <div className="nd-hub-page">
        ...
        <div className={styles.pageLayout}>
          ...
          >
            ...
            <MetaChips items={["~2.5 hours, self-paced", "Free", "TypeScript"]} />
